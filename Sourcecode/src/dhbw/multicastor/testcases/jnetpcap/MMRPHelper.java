...
public abstract class MMRPHelper {
	...
	public static Pcap setUpPcap() throws IOException {
		...
		device = new PcapIf();
		device = alldevs.get(4);
		address = device.getHardwareAddress();
