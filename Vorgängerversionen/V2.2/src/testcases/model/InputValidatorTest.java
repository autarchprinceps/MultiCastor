...
public class InputValidatorTest extends TestCase {
	...
	/**
	 * Test method for {@link zisko.multicastor.program.model.InputValidator#check_MMRP(java.lang.String)}.
	 */
	public final void testCheckMAC() {
		String variable1 = "00:00:00:00:00:00";
		String variable2 = "FF:FF:FF:FF:FF:FF";
		String variable3 = "ab:00:5e:00:00:01";
		String variable4 = "00:00:5D:FF:FF:FG";
		String variable5 = "99:00-12-ab-ff-12";
		String variable6 = "99:0:12:ab:ff:12";
		
		assertEquals(true, InputValidator.check_MMRP(variable1));
		assertEquals(true, InputValidator.check_MMRP(variable2));
		assertEquals(true, InputValidator.check_MMRP(variable3));
		assertEquals(false, InputValidator.check_MMRP(variable4));
		assertEquals(false, InputValidator.check_MMRP(variable5));
		assertEquals(false, InputValidator.check_MMRP(variable6));
	}
	...
	/**
	 * Test method for {@link zisko.multicastor.program.model.InputValidator#checkMC_MMRP(java.lang.String)}.
	 */
	public final void testCheckMC_MMRP() {
		String variable1 = "01:00:5E:00:00:01";
		String variable2 = "01:00:5e:00:00:01";
		String variable3 = "01-00-5E-00-00-01";
		String variable4 = "01-00-5e-00-00-01";
		String variable5 = "01-00-5E-FF-FF-FF";
		String variable6 = "01-00-5E-80-00-00";
		String variable7 = "01-00-5E-00-0-01";
		String variable8 = "01-00-5E-G0-00-01";
		
		assertEquals(true, InputValidator.checkMC_MMRP(variable1));
		assertEquals(true, InputValidator.checkMC_MMRP(variable2));
		assertEquals(true, InputValidator.checkMC_MMRP(variable3));
		assertEquals(true, InputValidator.checkMC_MMRP(variable4));
		assertEquals(false, InputValidator.checkMC_MMRP(variable5));
		assertEquals(false, InputValidator.checkMC_MMRP(variable6));
		assertEquals(false, InputValidator.checkMC_MMRP(variable7));
		assertEquals(false, InputValidator.checkMC_MMRP(variable8));
	}
	...
	/**
	 * Test method for {@link zisko.multicastor.program.model.InputValidator#checkMmrpPacketLength(java.lang.String)}.
	 */
	public final void testCheckMMRPPacketLength() {
		String variable1 = "1024";
		String variable2 = "52";
		String variable3 = "1501";
		String variable4 = "ab";
		String variable5 = "01024";
		
		assertEquals(Integer.parseInt(variable1), InputValidator.checkMmrpPacketLength(variable1));
		//out of range
		assertEquals(-1, InputValidator.checkMmrpPacketLength(variable2));
		//out of range
		assertEquals(-1, InputValidator.checkMmrpPacketLength(variable3));
		//Invalid number format
		assertEquals(-2, InputValidator.checkMmrpPacketLength(variable4));
		assertEquals(Integer.parseInt(variable5), InputValidator.checkMmrpPacketLength(variable5));
	}
